...
export const BoostScoreGraph = ({ periods = [], annotations = [], startDate = 0, endDate = 0, title, isPlaceholder = false, }) => {
    ...
    return (_jsxs("div", { className: "jb-score-graph", children: [title && _jsx(Text, { variant: "title-medium", children: title }), isPlaceholder ? (_jsx("div", { className: "jb-score-graph__placeholder", children: _jsx(Background, {}) })) : (_jsx(UplotLineChart, { periods: periods, annotations: annotations, range: { startDate, endDate } }))] }));
};
