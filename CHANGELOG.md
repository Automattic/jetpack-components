...
### Changed
- Update component that render the terms of service to have a text-only version
...
[0.70.0-alpha]: https://github.com/Automattic/jetpack-components/compare/0.69.1...0.70.0-alpha
